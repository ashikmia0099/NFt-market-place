...
export default function Admin_Sidebar() {
    ...
    const menuItems = [
        ...
        { href: '/Admin_Dashboard/All_User', icon: FaUsers, label: 'All User' },
        { href: '/Admin_Dashboard/All_Bids', icon: PiShoppingBagOpenFill, label: 'Bids' },
        { href: '/Admin_Dashboard/All_Nft_Category', icon: BiSolidCategoryAlt, label: 'NFT Category' },
        { href: '/Admin_Dashboard/All_Collection', icon: MdCollections , label: 'Collection' },
                ...
                return (
                    <div key={index} className='relative group flex items-center justify-center'>
                        ...
                        <div className="absolute left-14 top-1/2 -translate-y-1/2 
                            ...
                            whitespace-nowrap transition-opacity duration-300 z-50 ml-2 font-semibold text-[#442C91]">
                            {item.label}
                        </div>
                    </div>
                )
