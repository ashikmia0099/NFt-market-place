...
export default function All_User_list() {
    return (
            ...
            <Table className="rounded-2xl">
                ...
                <TableHeader className=" bg-white h-20 py-10 border-none my-10">
                    <TableRow className='px-5'>
                        ...
                        <TableHead className="text-xl font-semibold text-center">User Name</TableHead>
                        <TableHead className="text-xl font-semibold text-center">User Email / Wallet Address</TableHead>
                        <TableHead className="text-xl font-semibold text-center">Total Transaction	</TableHead>
                        <TableHead className="text-xl font-semibold text-center">Recent Transaction	</TableHead>
