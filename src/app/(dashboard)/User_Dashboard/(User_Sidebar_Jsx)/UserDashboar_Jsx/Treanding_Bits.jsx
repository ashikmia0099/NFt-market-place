...
export default function Treanding_Bits() {
    return (
        <div className=' px-10'>
            {/* category section */}

            <div className='my-10 mt-20 space-x-5 flex justify-between items-center'>
                <div>
                    <h1 className=' text-3xl font-bold'>Trending Bids</h1>
                </div>
                <div>
