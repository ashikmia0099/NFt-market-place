                            ...
                            Discovers.map((discover, index) => <SwiperSlide>
                                <div key={index} className=' h-[470px] rounded-[20px]'>
                                    <div className='h-[296px] '>
                                        <img src={discover.bannerImage} className=' w-full rounded-tl-[20px] rounded-tr-[20px] h-[296px]'></img>
                                    </div>
                                    <div className=' h-[173px] px-8 py-3 bg-[#3B3B3B] rounded-bl-[20px] rounded-br-[20px] ' >
                                        <Link href={`/MarketPlaces/${discover.id}`}><h4 className=' text-2xl font-semibold text-white'>{discover.NftName}</h4></Link>
